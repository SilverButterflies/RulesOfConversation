...
- when is it your turn to speak?
  Its all a lie. There are no turns. It is not illegal to interrupt others. However, it is only fair that each person gets to speak around the same amount of time (modulated for how much each person wants to speak). So, in general you may interrupt a person if they are not in the middle of an anecdote (something with a clear beginning, middle, and end), and they have spoken for more than the average amount of time a person speaks, in this particular conversation. If you begin speaking simultaneously with other people, the person who has spoken for least time recently, gets priority. If this is not you, stop speaking (you may add a little "go ahead" to indicate that the other person can speak). If this is you, continue speaking and ignore the other person until they take the hint. 
